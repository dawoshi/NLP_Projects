...
#ifndef GENC_CC_INTRINSICS_LOGICAL_NOT_H_
#define GENC_CC_INTRINSICS_LOGICAL_NOT_H_
...
class LogicalNot : public InlineIntrinsicHandlerBase {
 public:
  LogicalNot() : InlineIntrinsicHandlerBase(kLogicalNot) {}
  virtual ~LogicalNot() {}
...
#endif  // GENC_CC_INTRINSICS_LOGICAL_NOT_H_
