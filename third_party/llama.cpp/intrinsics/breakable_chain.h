...
#ifndef GENC_CC_INTRINSICS_BREAKABLE_CHAIN_H_
#define GENC_CC_INTRINSICS_BREAKABLE_CHAIN_H_

namespace genc {
namespace intrinsics {
class BreakableChain : public ControlFlowIntrinsicHandlerBase {
 public:
  BreakableChain() : ControlFlowIntrinsicHandlerBase(kBreakableChain) {}
  virtual ~BreakableChain() {}
...
#endif  // GENC_CC_INTRINSICS_BREAKABLE_CHAIN_H_
