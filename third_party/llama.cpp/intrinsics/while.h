...
#ifndef GENC_CC_INTRINSICS_WHILE_H_
#define GENC_CC_INTRINSICS_WHILE_H_
...
class While : public ControlFlowIntrinsicHandlerBase {
 public:
  While() : ControlFlowIntrinsicHandlerBase(kWhile) {}
...
#endif  // GENC_CC_INTRINSICS_WHILE_H_
